            ...
            <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php foreach($object->allEnroledBkook() as $con=>$row) {						   
						   ...
						   $date = strtotime("+7 day", $issueDate);
						   $timestamp=time();
						   if((($timestamp-$issueDate)/(24*60*60))>7)
					        {
								$status="<span style='color: Red'><b>Date Exited </b></span>";
						    }
							if((($timestamp-$issueDate)/(24*60*60))<=7)
							{
								$status="<span style='color: Green'><b>Under Date</b></span>";
						    }	
						?>
                      <tr>
                        <td><?= $con+1;?></td>

      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Employee Attendance System </a></li>
            <li class="active">Add Employee Attendanced</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Add Employee Attendance</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;">
                      <option Value="">Select A Employee Code</option>
               ...
               <div class="col-md-6">
                 <div class="form-group">
				  <label>Employee Login Time</label>

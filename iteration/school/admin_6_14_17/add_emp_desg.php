			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
               ...
               <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <select name="dept_id" class="form-control select2" style="width: 100%;" required>
				...
				<div class="col-md-6">
                 <div class="form-group">
				  ...
				  <input type="text" name="designation" class="form-control" required placeholder="Enter A Designation  Name...">
				</div>                 
                </div><!-- /.col -->  
                  <div class="col-md-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="emp_desg_st" class="flat-red" value="1" required>
                      Enable Designation
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                ...
                <div class="col-md-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="emp_desg_st" value="0" class="flat-red" required>
                      Dissabled Designation
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                </div><!-- /.col -->             
                <div class="col-md-6">
                 <div class="form-group">				  
				 <button type="submit" name="add_emp_desg" class="btn btn-primary">Submit</button>
				</div>                 
                </div><!-- /.col -->               

     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Enroll Book To Student
            <small>Data Entry Form</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Enroll Book To Student</a></li>
            <li class="active">Enroll Book To Student</li>
          </ol>
        </section>
          ...
          <div class="box box-default">
			...
			<form method="post">
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <img src="dist/img/boy-512.png" width="90" height="80" />                					
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->				
				<div class="libcard_enroll">
                </div>				
				</form>
              </div><!-- /.row -->
            </div><!-- /.box-body -->            

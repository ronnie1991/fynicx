      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Student Class</li>
          </ol>
        </section>
              ...
              <div class="row">
                <div class="col-md-6">
                 <div class="form-group">
				  ...
				  <input type="text" name="class_name" class="form-control" placeholder="Enter A Class ..." required>
				</div>                 
                </div><!-- /.col -->               
              </div><!-- /.row -->
			  <div class="row">
                <div class="col-md-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="cl_st" class="flat-red" value="1" required>
                      Enable Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                ...
                <div class="col-md-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="cl_st" value="0" class="flat-red" required>
                      Dissabled Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  

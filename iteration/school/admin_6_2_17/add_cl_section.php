     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Class Section  
            <small>Class Section Data Entry</small>
          </h1>
          <ol class="breadcrumb">
              ...
              <div class="row">
               ...
               <div class="col-md-6">
                 <div class="form-group">
				  ...
				  <input type="text" name="sec_name" class="form-control" placeholder="Enter A Class Section..."required>
				</div>                 
                </div><!-- /.col --> 				
              </div><!-- /.row -->
			  <div class="row">
                <div class="col-md-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="cl_sec_st" class="flat-red" value="1" required>
                      Enable Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                ...
                <div class="col-md-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="cl_sec_st" value="0" class="flat-red" required>
                      Dissabled Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                ...
                <div class="col-md-6">
                 <div class="form-group">				  
				 <button type="submit" name="add_class_sec" class="btn btn-primary">Submit</button>
				</div>                 
                </div><!-- /.col -->               
              </div><!-- /.row -->
			  </form>

          ...
          <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">You Can View All Student Result</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php foreach($object->allStudentResult() as $con=>$row) {
						$class=$object->singelClass($row['class']);
						$section=$object->singelClassSect($row['section']);
						$exam=$object->singelExamType($row['exam_type']);
						$examTT=$object->singelExamTT($row['exam_code']);

			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
				...
				<div class="col-sm-6">
                  <div class="form-group">
                   ...
                   <input class="form-control" name="achiv_dt" required data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" type="text">				
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->				
				<div class="col-md-3">
				   <div class="form-group">
                      <label for="exampleInputFile">Achiver`s Image</label>
                      <input type="file" id="exampleInputFile" name="achiver_img" required>

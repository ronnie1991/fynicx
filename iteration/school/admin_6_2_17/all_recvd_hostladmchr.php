     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          New Student Hostel Admission Charges Ledger            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Hostel Admission Charges</a></li>
            <li class="active">Student Hostel Admission Ledger</li>
          </ol>
        </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
			 ...
			 if(isset($_GET['y'])&&($_GET['cls'])&&($_GET['sec']))
			  {
				  echo "Hostel Admission Data From Student ";
			  }
			  else
			  {

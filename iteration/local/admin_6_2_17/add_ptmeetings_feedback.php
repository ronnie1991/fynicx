     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Parents Teacher Meetings Feedback
            <small>Meeting Feedback</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Parents Teacher Meetings Feedback</a></li>
            <li class="active">Add A Meeting Feedback</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <!-- SELECT2 EXAMPLE -->
		  <?php
				if(isset($_POST['add_pt_meeting_feedbk']))
				{
				if($_POST['form_id']==$_SESSION['session_form'])
				{
				$_SESSION['session_form']='';
				$msg=$object->addPTMetFeedback();
				}                					
				}
				else
				{
			...
			<form method="post">
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
                 ...
                 <div class="form-group">
                    ...
                    <select id="classId" name="meet_for" class="form-control select2 clas" style="width: 100%;" required>
				...
				<div class="col-md-6">
                  <div class="form-group">
                    <label>Meeting Feedback</label>
                    <textarea name="pt_meeting_feedbk" class="form-control" rows="3" placeholder="Enter Feedback..."></textarea>                 					
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->									
				<div class="col-sm-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="ptmet_feedbk_status" class="flat-red" value="1" >
                      Enable Feedback
                    </label>
                  </div>
                  <!-- /.form-group -->                  
				...
				<div class="col-sm-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="ptmet_feedbk_status" value="0" class="flat-red" >
                     Disable Feedback
                    </label>
                  </div>
                  <!-- /.form-group -->                  
				 ...
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="add_pt_meeting_feedbk" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->

              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="subj_name" placeholder="Enter Subject Name" required type="text">            					
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->					
              </div><!-- /.row -->              
			  <div class="row">
                <div class="col-md-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="subj_st" class="flat-red" value="1" required>
                      Enable Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                ...
                <div class="col-md-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="subj_st" value="0" class="flat-red" required>
                      Dissabled Class
                    </label>
                  </div>
                  <!-- /.form-group -->                  

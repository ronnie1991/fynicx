...
<div class="gt_wrapper">
    ...
    <?php include_once("header.php");
     $gNSDtls=$main->singlGNSMultiImg(base64_decode($_GET['gNsI']));
     ?>     
    <!--Header Wrap End-->
            ...
            <div class="container">
                <div class="row">
                    <div id="filterable-item-holder-1" class="row">
                        <?php if($gNSDtls['gmsnsport_multi_img'] !='') { ?>
                        <?php
                         $temp = explode(',',$gNSDtls['gmsnsport_multi_img']);
                          foreach($temp as $image){                  
                         ?>
                        <div class="filterable-item  col-md-3 col-sm-6 col-xs-12">
                            <div class="edu_masonery_thumb">
                                <figure>
                                    <img src="extra-images/games_sports/<?= $image?>" alt="" style="border-radius: 3px; width: 263px !important;height: 263px !important;"/>
                                    <a href="extra-images/games_sports/<?= $image?>" data-rel="prettyPhoto"><i class="fa fa-search"></i></a>
                                </figure>
                            </div>  
                        </div>
                        <?php } } ?>                

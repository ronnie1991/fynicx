...
<div class="gt_wrapper">
        ...
        <div class="container">
            <div class="gt_sub_banner_hdg  default_width">
                ...
                <ul>
                    ...
                    <li><a href="events">Co-Curricular</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="gt_main_content_wrap">
        ...
        <section>
            <div class="container">
                <div class="row">
               <?php foreach ($main->allCoCurricular() as $coCurriRow) {
                $coCurriId=base64_encode($coCurriRow['id']);
                $evnDt=date("d/m/Y", strtotime($coCurriRow['co_curricular_date']));
                $expDt=explode('/',$evnDt);
                ?>
               <a href="cocurricu-multiple-images?coCuriCuI=<?= $coCurriId;?>">
                <div class="col-md-6">                    
                    <div class="gt_latest_news_wrap default_width mb">
                        <img src="extra-images/co-curricular/<?= $coCurriRow['co_curricular_img']?>" alt="">
                        <div class="gt_news_des_wrap default_width">
                            ...
                            <div class="gt_latst_new_des">
                                <h5><?= htmlspecialchars( $coCurriRow['co_curricular_title']);?></h5>
                                <ul>
                                    <li><b>Topic :</b> <?= htmlspecialchars( $coCurriRow['co_curricular_topic']);?> </li>           
                                </ul>
                                <p><?= htmlspecialchars( $coCurriRow['co_curricular_brief']);?></p>
                            </div>
                        </div>
                    </div>                
                </div>  

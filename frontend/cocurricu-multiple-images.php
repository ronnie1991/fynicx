...
<div class="gt_wrapper">
    ...
    <?php include_once("header.php");
     $coCuriCUDtls=$main->singlCoCuriCuMultiImg(base64_decode($_GET['coCuriCuI']));
     ?>     
    <!--Header Wrap End-->
    ...
    <div class="gt_sub_banner_bg default_width">
        <div class="container">
            <div class="gt_sub_banner_hdg  default_width">
                <h3><?= $coCuriCUDtls['co_curricular_title'];?></h3>
                <ul>
            ...
            <div class="container">
                <div class="row">
                    <div id="filterable-item-holder-1" class="row">
                        <?php if($coCuriCUDtls['co_curricular_multpl_img'] !='') { ?>
                        <?php
                         $temp = explode(',',$coCuriCUDtls['co_curricular_multpl_img']);
                          foreach($temp as $image){                  
                         ?>
                        <div class="filterable-item  col-md-3 col-sm-6 col-xs-12">
                            <div class="edu_masonery_thumb">
                                <figure>
                                    <img src="extra-images/co-curricular/<?= $image?>" style="border-radius: 3px; width: 263px !important;height: 263px !important;" alt=""/>
                                    <a href="extra-images/co-curricular/<?= $image?>" data-rel="prettyPhoto"><i class="fa fa-search"></i></a>
                                </figure>
                            </div>  
                        </div>
                        <?php } } ?>                

...
<div class="gt_wrapper">
        ...
        <div class="container">
            <div class="gt_sub_banner_hdg  default_width">
                ...
                <ul>
                    ...
                    <li><a href="events">Games & Sports</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="gt_main_content_wrap">
        ...
        <section>
            <div class="container">
                <div class="row">
               <?php foreach ($main->allGamesNSports() as $gnsRow) {
                $gamesNSportsId=base64_encode($gnsRow['id']);
                $evnDt=date("d/m/Y", strtotime($gnsRow['gmsnsport_date']));
                $expDt=explode('/',$evnDt);
                ?>
               <a href="gns-multiple-images?gNsI=<?= $gamesNSportsId;?>">
                <div class="col-md-6">                    
                    <div class="gt_latest_news_wrap default_width mb">
                        <img src="extra-images/games_sports/<?= $gnsRow['gmsnsport_img']?>" alt="">
                        <div class="gt_news_des_wrap default_width">
                            ...
                            <div class="gt_latst_new_des">
                                <h5><?= htmlspecialchars( $gnsRow['gmsnsport_title']);?></h5>
                                <ul>
                                    <li><b>Topic :</b> <?= htmlspecialchars( $gnsRow['gmsnsport_topic']);?> </li>           
                                </ul>
                                <p><?= htmlspecialchars( $gnsRow['gmsnsport_breif']);?></p>
                            </div>
                        </div>
                    </div>                
                </div>  

     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          New Student General Admission Charges Ledger            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">General Admission Charges Ledger</a></li>
            <li class="active">New Student General Admission</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
			 ...
			 if(isset($_GET['y'])&&($_GET['cls'])&&($_GET['sec']))
			  {
				  echo "General Admission Charges Ledger ";
			  }
			  else
			  {
          ...
          $curnUrl=$_SERVER['REQUEST_URI'];         
          $explodUri=explode('?',$curnUrl);
          $exExclUri="expExlAdm?".$explodUri[1];           
			?>
			<div class="col-xs-12">
            <div class="box">
          ...
          <div class="box-tools pull-right">          
            <a class="btn" style="padding: 6px 12px;background:#dddddd;color: #080808; " href="<?= $exExclUri;?>"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Export as Excel</b></a>             
          </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>  
					  ...
					  $stuGenAdLedger=$object->findAStuGenerlAdmisonLedger($stRo['admission_number'],$yar);
    ...
    <script>
      $(function () {
		  ...
		  $(document).on('change','.sec',function(){
			   ...
			   var yar=btoa(rwYrId);			  
			    $.ajax({
				  url:'ajax_recvgenadm_charges',
				  data:{secid:secid,cls:clid,yar:yar},
				  type : 'POST' ,
				  cache:false,
				  success:function(data){
				  $(".st_recvdgenadm_charges").html(data);	
                  var curnt_url=window.location.href;  

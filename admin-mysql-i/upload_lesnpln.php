     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Lesson Plan
            <small>Upload Lesson Plan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Lesson Plan</a></li>
            <li class="active">Upload Lesson Plan</li>
          </ol>
        </section>
			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
              <div class="col-md-2">
                  <div class="form-group">
                    <label>Lesson Plan Date</label>
                    <input name="lessonplan_date" type="date" id='recevdate' placeholder="Lesson Plan Date" required >                					
                  </div><!-- /.form-group -->                  
               </div><!-- /.col -->
			   <div class="col-md-4">
                  <div class="form-group">
				...
				<div class="col-sm-6">
                  ...
                  <input id="exampleInputFile" type="file" name="lessonplan_file" required>			
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->
				...
				<div class="col-sm-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="lessonplan_status" class="flat-red" value="1" required >
                      Enable Lesson Plan
                    </label>
                  </div>
                  <!-- /.form-group -->                  
				...
				<div class="col-sm-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="lessonplan_status" value="0" class="flat-red" >
                     Dissabled Lesson Plan
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                </div><!-- /.col -->
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="add_lessonplan" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->

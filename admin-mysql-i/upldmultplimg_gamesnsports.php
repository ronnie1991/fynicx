  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <?php include_once('left_asid.php'); ?>
        ...
        $id=base64_decode($_GET['gns_id']);
        if(isset($_POST['multiplimgup']))
        {
        $msg=$object->addGNSMultiplImage($id);
        }
        ?>
      <!-- Modal Content -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
             <ul class="timeline">
              <?php $singelGamesNSports=$object->singelGamesNSports($id);  ?>
                <!-- timeline time label -->
                <li class="time-label">
                  <span class="bg-red">                   
                    <?= $singelGamesNSports['gmsnsport_date'];?>
                  </span>
                </li>
                <!-- /.timeline-label -->
                <!-- timeline item -->                
                <li>
                  ...
                  <span class="time"><i class="fa fa-clock-o"></i> <?= DATE('H:i',$singelGamesNSports['up_time']); ?></span>                   
                    <h3 class="timeline-header"> 
                      <a href="#"><?=$singelGamesNSports['gmsnsport_title'] ;?></a></h3>
                    <div class="timeline-body">
                       <img src="../frontend/extra-images/games_sports/<?= $singelGamesNSports['gmsnsport_img'];?> " alt="..." width="250" height="110" >
                      Topic - <?= $singelGamesNSports['gmsnsport_topic'];?>   &nbsp;&nbsp; Brief - <?= $singelGamesNSports['gmsnsport_topic'];?>  &nbsp;&nbsp;                    
                    </div>

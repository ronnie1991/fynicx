...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php foreach($object->allClassDairy() as $con=>$row) {						  
                      ...
                      <tr>
                        ...
                        <td><a href="update_class_diary?did=<?= base64_encode($row['id']);?>" title="Update"><img src="dist/img/pencil.png" width="24" height="24" title="Edit" ></a>&nbsp;&nbsp; <a href="#" title="Delete Entity" class="delete" onClick="return false" ><img src="dist/img/remove-icon.png" width="24" height="24"  title="Delete" id="<?= $row['file']; ?>" style="cursor:pointer"></a></td>             								
                      </tr>
					  <?php } ?>
                    </tbody>
                    <tfoot>
    ...
    <script>
      ...
      if(chk)
      {
      var classDiaryId = $(this).children('img').attr('id');    
      var row=$(this).parent().parent();
        $.ajax({

        url:'all_delete',       

        data:{classDiaryId:classDiaryId},

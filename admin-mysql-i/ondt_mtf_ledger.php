    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            On Date Monthly Tuition Fees Collections             
          </h1>          
        </section>
          ...
          <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Total-> <b><?=$object->onDtTotlMonthlyFees();?> r.s</b> of Monthly Tuition Fees Collected On Date- <b><?= date("d-M-Y"); ?></b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
          <?php foreach($object->onDtTotlMonthlyFeesDetls() as $con=>$row) {

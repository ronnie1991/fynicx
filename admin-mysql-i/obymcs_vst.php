     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Obtain credentials to display student attendance list           
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Student Official</a></li>
            <li class="active">View Studet</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Select A Year, Month, Class & Section To Retrieve Data</h3>
            ...
            <div class="st_recvdgenadm_charges">
			<form method="post">
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Year</label>
                    <select id="yerId"  class="form-control select2 yer" name="year" required style="width: 100%;">
                ...
                <div class="col-md-2 mnth" style="display:none">
                  <div class="form-group">
                    <label>Month</label>
                    <select id="yerId"  class="form-control select2 month" name="year" required style="width: 100%;">
                      <option value="" >Select Month</option>
                       <?php for($i=1;$i<=12;$i++) { 
					   $mNTEC=$object->numrcMonth($i);	
					   ?>
                      <option value="<?= $i;?>" ><?= $mNTEC;?></option>
                        <?php } ?>
                    </select>                  					
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->				
				<div class="col-md-2 cls" style="display:none">
                  <div class="form-group">
                    <label>Class</label>
    ...
    <script>
      $(function () {
		   $(".yer").change(function(){            
			  var rwYrId=$(this).val();
                 ...
                 if(yar!='')
				 {
					 ...
					 var modif_url=curnt_url+'?yr='+yar;					 
					 history.pushState({},null,modif_url);					
				 }					 
			        	
		  });
		  $(".month").change(function(){            
			  var rwMntId=$(this).val();
                 var mnth=btoa(rwMntId);			  
                 if(mnth!='')
				 {
					 $(".cls").show("slow");   
					 var curnt_url=window.location.href;  
					 var modif_url=curnt_url+'&mnt='+mnth;					 
					 history.pushState({},null,modif_url);					
				 }					 
		  ...
		  $(document).on('change','.sec',function(){
				...
				window.location.href = 'all_student_attendance?'+parms[1];			  
		  });

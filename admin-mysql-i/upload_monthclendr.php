     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Monthly Calendar 
            <small>Upload Monthly Calendar</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Monthly Calendar</a></li>
            <li class="active">Upload Monthly Calendar</li>
          </ol>
        </section>
			...
			<form method="post"enctype="multipart/form-data" >
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
               <div class="col-md-6">
				...
				<div class="col-sm-6">
                  <div class="form-group">
                    <label>Monthly Calendar File</label>
                  <input id="exampleInputFile" type="file" name="montlyClndr_file" required>			
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->
				...
				<div class="col-sm-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="montlyClndr_status" class="flat-red" value="1" required >
                      Enable Monthly Calendar
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                </div><!-- /.col -->
				<div class="col-sm-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="montlyClndr_status" value="0" class="flat-red" >
                     Dissabled Monthly Calendar
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                </div><!-- /.col -->
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="add_MontlyClndr" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->

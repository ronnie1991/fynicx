     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Class Diary
            <small>Upload Diary</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Class Diary</a></li>
            <li class="active">Upload Diary</li>
          </ol>
        </section>
			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
              <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input name="clsdiry_date" type="date" id='recevdate' placeholder="Schedule Date" required >                					
                  </div><!-- /.form-group -->                  
               </div><!-- /.col -->
			   <div class="col-md-4">
                  <div class="form-group">
				...
				<div class="col-sm-6">
                  ...
                  <input id="exampleInputFile" type="file" name="clsdiry_file" required>			
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->
				...
				<div class="col-sm-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="clsdiry_status" class="flat-red" value="1" required >
				...
				<div class="col-sm-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="clsdiry_status" value="0" class="flat-red" >
				 ...
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="add_clsdiry" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->

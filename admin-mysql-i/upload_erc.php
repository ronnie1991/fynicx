     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Exam Report Card
            <small>Upload Exam Report Card</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Exam Report Card</a></li>
            <li class="active">Upload Exam Report Card</li>
          </ol>
        </section>
			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
              <div class="col-md-2">
                  <div class="form-group">
                    <label>Report Card Date</label>
                    <input name="erc_date" type="date" id='recevdate' placeholder="Report Card Date" required >                					
                  </div><!-- /.form-group -->                  
               </div><!-- /.col -->
			   <div class="col-md-4">
                  <div class="form-group">
				...
				<div class="col-sm-6">
                  ...
                  <input id="exampleInputFile" type="file" name="erc_file" required>			
                  </div><!-- /.form-group -->                  
                </div><!-- /.col -->
				...
				<div class="col-sm-3">
				   <div class="form-group">              
                    <label>
                      <input type="radio" name="erc_status" class="flat-red" value="1" required >
                      Enable Report Card
                    </label>
                  </div>
                  <!-- /.form-group -->                  
				...
				<div class="col-sm-3">
				   <div class="form-group">            
                    <label>
                      <input type="radio" name="erc_status" value="0" class="flat-red" >
                     Dissabled Report Card
                    </label>
                  </div>
                  <!-- /.form-group -->                  
                </div><!-- /.col -->
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="erc_clsdiry" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->

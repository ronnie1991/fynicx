    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            All Slider Image
            <small>Slider Image</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Slider Image</a></li>
        ...
        <section class="content">
          <div class="row">
            <div class="col-sm-8">
              ...
              <ul class="timeline">
                <!-- timeline time label -->
                 <?php foreach($object->findAllSliderImgs() as $row) {
                   if($row['status']==1)
                   {
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    <span class="time"><i class="fa fa-clock-o"></i> <?= date("H:i",$row['intime']); ?></span>
                    <h3 class="timeline-header">Created By- <a href="#"><?= $row['created_by']; ?></a> </h3>
                    <div class="timeline-body">
                      <img src="../frontend/extra-images/slider/<?= $row['image_name'];?>" alt="..." width="250" height="120" class="margin">
                    </div>
                    <div class="timeline-footer"> 
                    Status- <a href="#"><?= $status; ?></a> |  &nbsp;&nbsp;
                    <a href="#">Change as Disabled? </a>               
                      &nbsp;&nbsp;<a href="#<?= $row['image_name']; ?>" title="Delete" onClick="return false"  class="btn btn-danger btn-xs delete">Delete</a>
                    </div>
                  </div>
                </li>
                <?php } ?>

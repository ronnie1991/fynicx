                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php foreach($object->allLibBook() as $con=>$row) {						 
                      ...
                      <tr>
                        ...
                        <td><a href=#" title="Update"><img src="dist/img/pencil.png" width="24" height="30" title="Edit" ></a>&nbsp;&nbsp; <img src="dist/img/remove-icon.png" width="35" height="29" title="Delete" imageID="<?= $row['id'];?>" style="cursor:pointer"></td>             				
                      </tr>
					  <?php } ?>
                    </tbody>
                    <tfoot>

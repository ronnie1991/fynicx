...
{
	$object->downloadExamReportCard($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en"> 
<head>
        ...
        <title> Exam Report Card | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Exam Report Card </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="dashboard"> Home </a> </li>
                                <li class="active"> Download Exam Report Card </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                    ...
                                    <tbody>
									   <?php foreach($object->findAllExamReportCard() as $row ){										    
										?>
                                        <tr>
                                            <td>

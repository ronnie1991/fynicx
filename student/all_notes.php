...
{
	$object->downloadStudMate($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en"> 
<head>
        ...
        <title> All Notes | Org. Name</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Study Material </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Download Notes </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                    <thead>
                                        <tr>
                                            <th data-sort-initial="true" data-toggle="true">Class</th>
                                            <th>Author</th>
                                            <th data-hide="phone, tablet">Subject</th>
                                            <th data-hide="phone, tablet">Brief</th>
                                            <th data-hide="phone, tablet">Update On</th>
                                            <th data-sort-ignore="true" class="min-width">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									   <?php foreach($object->findAllStudyMaterial() as $row ){
										    $class=$object->singleClass($row['class']);
										    $subject=$object->singleSubject($row['subject']);
										?>
                                        <tr>
                                            <td><?= $class['class']; ?></td>
                                            <td><?= $row['author']; ?></td>
                                            <td><?= $subject['subject_name']; ?></td>
                                            <td><?= substr($row['bref_desc'],0,50); ?>....</td>
                                            <td><span class="label label-table label-success"><?= date("d/m/y h:i:s",$row['updated_time']); ?></span></td>
                                            <td>
                                                <a href="?action=download&id=<?= $row['id'];?>" class="btn btn-info glyphicon glyphicon-download-alt download"></a>
                                            &nbsp;&nbsp;
											<button class="btn btn-success glyphicon glyphicon-eye-open"></button>
											</td>
                                        </tr>    
                                       <?php } ?>										
                                    </tbody>

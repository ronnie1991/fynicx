                    ...
                    <div class="navbar-header">
                        <a href="dashboard" class="navbar-brand">
                            ...
                            <div class="brand-title">
                                <span class="brand-text">AGPN</span>
                            </div>
                        </a>
                    </div>
                    <!--================================-->
                        ...
                        <ul class="nav navbar-top-links pull-right">
                            ...
                            <li id="dropdown-user" class="dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
									...
									<?php
									  $usrNam=$_SESSION['user_name'];
									  $stuInfo=$object->studentInfo();
									   if($stuInfo['student_img'] !='')
									   {
										 $imgname='../common/students/student_img/'.$stuInfo['student_img'];
									   }
									   else
									   {
										  $imgname='img/user-male.jpg'; 
									   }
									   
									?>
									<img class="img-circle img-user media-object" src="<?= $imgname;?>" width="103px" height="103px"> </span>
                                    <div class="username hidden-xs"><?= $usrNam;?></div>
                                </a>

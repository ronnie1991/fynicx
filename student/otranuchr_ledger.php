...
<head>
        ...
        <title> Other Anual Charges | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Other Annual Charges Ledger</h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Other Annual Charges:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                            ...
                                            <div class="col-sm-6 text-xs-center">
                                                <div class="form-group">
                                                    ...
                                                    <select id="demo-foo-filter-status" class="form-control">
                                                        ...
                                                        <option value="active">Class Test</option>
                                                        <option value="disabled">Midterm</option>
                                                        <option value="suspended">Final</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <th data-sort-initial="true" data-toggle="true">Date</th>
                                              <th data-hide="phone, tablet">Particulars</th>
                                            <th data-hide="phone, tablet">Charges</th>
                                            <th data-hide="phone, tablet">Paid Amount</th>                                          
                                        </tr>
                                    </thead>
                                    <tbody>
									   <?php foreach($object->otherAnulChrgsLedgerStudent() as $othranuFesLedg) {
									    $otranuchFeeAdm=$object->othrAnulChrgsAdmin($othranuFesLedg['particulars']); 
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$othranuFesLedg['in_time']);?></td>                               
                                            <td><?= $otranuchFeeAdm['particulars'];?></td>
                                            <td><?= $otranuchFeeAdm['charges'];?></td>
											<td><?= $othranuFesLedg['paid_amoount'];?></td>
                                        </tr>    
                                       <?php  } ?>										
                                    </tbody>
                                    <tfoot>

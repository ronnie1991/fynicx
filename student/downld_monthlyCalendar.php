...
{
	$object->downloadMonthlyCalendar($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en"> 
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Monthly Calendar </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Download Monthly Calendar </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                    ...
                                    <tbody>
									   <?php foreach($object->findAllMonthlyCalendar() as $row ){										    
										?>
                                        <tr>
                                            <td>
											<span class="label label-table label-success">
											<?= DATE('M d Y',$row['intime']); ?>
											</span></td>
                                            <td><?= $row['file']; ?></td>                                          
                                            <td>
											<a href="?action=download&id=<?= $row['id'];?>" class="btn btn-info glyphicon glyphicon-download-alt download"></a></td>                                          
                                        </tr>    
                                       <?php } ?>										
                                    </tbody>
                                    <tfoot>

            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Hostel Admission Ledger </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Hostel Admission Ledger </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    ...
                                    <tbody>
									   <?php $hostlAdmisFL=$object->hostelAdmissionLedger(); 
									    $hostlAdmisChar=$object->hostelAdmisChrges(); 
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$hostlAdmisFL['in_time']);?></td>                               
                                            <td><?= $hostlAdmisChar['adho_fees'];?></td>
											<td><?= $hostlAdmisFL['payed_amount'];?></td>
                                        </tr>    
                                       <?php  ?>										
                                    </tbody>
                                    <tfoot>

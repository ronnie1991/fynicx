...
<head>
        ...
        <title> All Holidays | Org. Name</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Holidays </h3>
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-hide="phone, tablet">Number Of Day</th>                                           
                                        </tr>
                                    </thead>
                                    <tbody>
									   <?php foreach($object->allHolidays() as $key=>$row ){
										    
										?>
                                        <tr>
                                            <td><?= $key+1; ?></td>
                                            <td><?= $row['holiday_nm']; ?></td>
                                            <td><?= $row['frm_date']; ?>&nbsp;(<?= date('l', strtotime($row['frm_date']));?>)</td>
                                            <td><?= $row['to_date']; ?>&nbsp;(<?= date('l', strtotime($row['to_date']));?>)</td>                                            
                                            <td><?= $row['no_day']; ?></td>                                 
                                        </tr>    
                                       <?php } ?>										
                                    </tbody>

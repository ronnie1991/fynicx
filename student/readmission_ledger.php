...
<head>
        ...
        <title> Hostel Admission Ledger | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Re-Admission Ledger </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Re-Admission Ledger:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Re-Admission Ledger </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    ...
                                    <tbody>
									   <?php foreach($object->reAdmissionLedger() as $reAdmisFL); {
									    $reAdmisChar=$object->reAdmisChrges(date("Y",$reAdmisFL['in_time'])); 
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$reAdmisFL['in_time']);?></td>                               
                                            <td><?= $reAdmisChar['re_admg_fees'];?></td>
											<td><?= $reAdmisFL['payed_amount'];?></td>
                                        </tr>    
                                       <?php  } ?>										
                                    </tbody>
                                    <tfoot>

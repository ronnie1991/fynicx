...
<head>
        ...
        <title> All Result | Org. Name</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Result </h3>
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-hide="phone, tablet">Total Marks</th>
                                            <th data-hide="phone, tablet">Passing Marks</th>
                                            <th data-sort-ignore="true" class="min-width">Obtaning</th>
                                            <th data-sort-ignore="true" class="min-width">Remarks</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									   <?php foreach($object->allResult() as $key=>$row ){
										    $exmTt=$object->ajaxExmTt($row['exam_code']);
										    $exmType=$object->ajaxExmType($row['exam_type']);
										?>
                                        <tr>
                                            <td><?= $key+1; ?></td>
                                            <td><?= $exmTt['exm_code']; ?></td>
                                            <td><?= $exmTt['subj_nm']; ?></td>
                                            <td><?= $exmType['max_marks']; ?></td>                                            
                                            <td><?= $exmType['min_marks']; ?></td>                               

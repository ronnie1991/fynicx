...
<head>
        ...
        <title>Monthly Fees Ledger | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Monthly Fees Ledger </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Monthly Fees Ledger:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Monthly Fees Ledger </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    ...
                                    <tbody>
									   <?php foreach($object->monthlyFeesLedgerStudent() as $monthlyFesLedg); {
									           $monthlyFeeAdm=$object->monthlyFeesAdmin(); 
											   $month=$object->numrcMonth($monthlyFesLedg['payment_month']);
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$monthlyFesLedg['in_time']);?></td>                               
                                            <td><?= $month;?></td>
                                            <td><?= $monthlyFeeAdm['fees'];?></td>
											<td><?= $monthlyFesLedg['paid_amount'];?></td>
                                        </tr>    
                                       <?php  } ?>										
                                    </tbody>
                                    <tfoot>

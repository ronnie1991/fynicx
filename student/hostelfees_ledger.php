...
<head>
        ...
        <title> Hostel Fees Ledger | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Hostel Fees Ledger </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Hostel Fees Ledger:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Hostel Fees Ledger </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    ...
                                    <tbody>
									   <?php foreach($object->hostelFeesLedgerStudent() as $hostelFesLedg); {
									    $hostlFeeAdm=$object->hostelFeesAdmin(); 
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$hostelFesLedg['in_time']);?></td>                               
                                            <td><?= $hostelFesLedg['payment_month'];?></td>
                                            <td><?= $hostlFeeAdm['hostel_fees'];?></td>
											<td><?= $hostelFesLedg['receving_amont'];?></td>
                                        </tr>    
                                       <?php  } ?>										
                                    </tbody>
                                    <tfoot>

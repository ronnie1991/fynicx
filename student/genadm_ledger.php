...
<head>
        ...
        <title> General Admission Ledger | AGPN</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> General Admission Ledger </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> General Admission Ledger </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">                           
                            <div class="panel-body">
                                ...
                                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                    ...
                                    <tbody>
									   <?php $genAdmisFL=$object->stuGenAdmLedger(); 
									    $genAdmisChar=$object->genrelAdmisChrges(); 
									   ?>
                                        <tr>
                                            <td><?= date("d M Y ",$genAdmisFL['in_time']);?></td>                               
                                            <td><?= $genAdmisChar['admg_fees'];?></td>
											<td><?= $genAdmisFL['payed_amount'];?></td>
                                        </tr>    
                                       <?php  ?>										
                                    </tbody>
                                    <tfoot>
